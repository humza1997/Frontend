                        ...
                        <form onSubmit={handleSubmit}>
                            <div class="space-y-5">
                                <div class="space-y-2">
                                    ...
                                    <input class=" shadow-sm border rounded-md w-full py-2 px-3 text-gray-700 mt-1 leading-tight  outline-none focus:outline-none focus-within:border-purple-400 transition-all duration-500 text-base rounded-lg" placeholder="shav@example.com" name="email" type="email"></input>
                                </div>
                                <div class="space-y-2">
