            ...
            <div id="errorbox" class="flex-1 min-w-full rounded-3xl bg-white shadow-xl p-10 lg:p-20 relative md:flex items-center text-center md:text-left">
                <div class="w-full md:w-1/2">
                    ...
                    <div class="mb-20 md:mb-0">
                        <NavLink to="/">
                            <button class="text-lg font-light outline-none focus:outline-none transform transition-all hover:scale-110 text-yellow-500 hover:text-yellow-600">                    <Icon path={mdiArrowLeft}
                                title="User Profile"
                                size={1}
